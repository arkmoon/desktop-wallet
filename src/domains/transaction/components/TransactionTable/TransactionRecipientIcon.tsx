...
const Wrapper = ({ children, className }: { children: React.ReactNode; className?: string }) => {
	return (
		<Circle
			data-testid="TransactionRecipientIcon"
...
export const TransactionRecipientIcon = ({ type, recipient, recipients, className }: Props) => {
...
TransactionRecipientIcon.defaultProps = {
	recipients: [],
};
